...
const members = [
  ...
  ["Anas", "Junior Full Stack Developer", "/team/anass.png", "Full-stack support across every active project, learning fast and shipping faster."],
  ...
  ["Meryem", "Project Manager", "/team/meryem.jpg", "Organized project manager ensuring smooth execution, clear communication, and on-time delivery across all projects."],
  ["Ayoub", "Media Buyer", "/team/unknown.png", "Strategic media buyer focused on scaling campaigns through data-driven ad optimization, audience targeting, and performance analysis across digital platforms."],
  ["Achraf", "Sales", "/team/unknown.png", "Results-driven sales professional skilled in client acquisition, relationship management, and converting leads into long-term partnerships."],
  ["Nada Ez Zorzar", "Sales", "/team/nada.png", "The team behind every call and every follow-up, from your first message to a booked meeting."],
  ["Yassmine Dhibi", "Sales", "/team/yassmine.png", "The team behind every call and every follow-up, from your first message to a booked meeting."],
];
...
export function Team() {
  return (
    <section id="team" className="relative z-1 mx-auto w-[min(100%-2.5rem,1180px)] py-20 sm:py-28">
      ...
      <Carousel opts={{ align: "start", loop: true, slidesToScroll: 1, dragFree: false }} className="relative mx-auto mt-12 w-full max-w-6xl">
